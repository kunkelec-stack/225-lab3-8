pipeline {
    ...
    environment {
        ...
        GITHUB_URL = 'https://github.com/kunkelec-stack/225-lab3-8.git'  // GitHub repository containing Kubernetes YAML files
        KUBECONFIG = credentials('kunkelec-225-sp26')             // Jenkins stored credential for accessing your Kubernetes cluster
    }
